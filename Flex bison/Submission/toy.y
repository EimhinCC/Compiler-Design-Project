...
input: 
Struct Word COpenB TypeList CCloseB {structAdd($2);}
|   FuncDef {}
|   input input {}
;
...
FuncCall:
Word OpenB Parameter CloseB SemiC{isDeclared($1, functions, l);$$ = 1;}
...
Type SemiC { $$ = $1; }
|   FuncCall { $$ = $1; }
|   Word EQU Number SemiC {isDeclared($1, ints,i); $$ = 1;}
|   Word EQU StringContent SemiC {isDeclared($1, strs,j);$$ = 2;}
|   Word EQU nExp SemiC {isDeclared($1, bools,k);$$ = 3;}
|   Statement {}
|   ReturnStatem {}
|   Code Code {}
;
...
|   aExp AND Word Compare Number {isDeclared($3, ints, i);$$ = true}
|   oExp {$$ = $1;}
